...
| `bobmani/bobmania` | master | `3ffa5eadd6` | 2026-02-08 | chore: remove stale theme path |
...
| `bobmani/itgmania` | main | `c0f7c1928b` | 2026-02-08 | chore: merge sync (resolved conflicts) |
| `bobmani/ksm-v2` | master | `4e05b3d` | 2026-02-08 | chore: merge jules/feature/configurable-songs-dir-... |
...
| `borg` | main | `085f5f94` | 2026-02-08 | chore: cleanup and sync nested submodules |
...
| `metamcp` | main | `f25a4f4` | 2026-02-08 | chore: merge test (resolved conflicts) |
| `mk64` | master | `fb626de29` | 2026-02-07 | chore: fix submodule configuration and update tool... |
| `opencode-autopilot` | main | `50eaf88` | 2026-02-08 | Enhance Web Dashboard with new tabs (History, Syst... |
| `raindropioapp` | master | `3317f0a5` | 2026-02-08 | chore: sync upstream changes |
...
| `topaz-ffmpeg` | master | `b8daba42cd` | 2026-02-07 | avformat/http: report connection statistics |