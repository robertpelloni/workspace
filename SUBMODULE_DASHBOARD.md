...
**Last Updated:** 2026-03-17 19:02:05
...
| :--- | :--- | :--- | :--- | :--- | :--- |
| bobfilez | N/A | main | 'e0b8350f' | '2026-03-17' | 'chore: save progress before update' |
| fwber | 0.5.0-beta | main | 'a455ea749' | '2026-03-08' | 'fix(ci): sync frontend lockfile for npm ci' |
| bobsaver | N/A | main | 'a94e612' | '2026-03-17' | 'chore: save progress before update' |
| borg | 2.7.333 | main | '99a13fb2' | '2026-03-17' | 'fix(mcp): implement 500-tool limit to avoid Gemin... |
...
| mk64 | N/A | master | 'e8560acf6' | '2026-03-05' | 'chore: save progress before update' |
| bobeditpro | N/A | master | '0fee71dfa' | '2026-03-11' | 'chore: save progress before update' |
| bobtrader | N/A | main | 'aa67b11' | '2026-03-11' | 'chore: save progress before update' |
| bobtorrent | 11.2.4 | master | '0390ac3' | '2026-03-11' | 'chore: save progress before update' |
...
| bobmani/beatoraja | 0.9.2 | master | '73bb70bc' | '2026-03-11' | 'chore: save progress before update' |
| bobmani/hymnmania | N/A | master | 'b3707aa' | '2026-03-05' | 'feat: Polish Web UI and document pipeline paramet... |
...
| bg | N/A | master | '81d49f25' | '2026-03-17' | 'chore: save progress before update' |
| .agent | N/A | main | 'e550cc89' | '2026-03-17' | 'Merge branch 'main' of https://github.com/sickn33... |
...
| bobbybookmarks | N/A | main | '2178c24' | '2026-03-17' | 'chore: save progress before update' |
...
| OmniRoute | N/A | main | '283d0e2' | '2026-03-17' | 'Merge branch 'main' of https://github.com/diegoso... |
