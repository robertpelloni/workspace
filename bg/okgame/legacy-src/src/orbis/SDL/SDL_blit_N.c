...
static const struct blit_table normal_blit_1[] = {
    ...
    {0, 0, 0, 0, 0, 0, 0, 0, BlitNtoN, (blit_table::atype)0}
};
...
static const struct blit_table normal_blit_2[] = {
    ...
    {0x0000F800, 0x000007E0, 0x0000001F, 4, 0x00FF0000, 0x0000FF00, 0x000000FF,
     0, Blit_RGB565_ARGB8888, (blit_table::atype)(blit_table::NO_ALPHA | blit_table::COPY_ALPHA | blit_table::SET_ALPHA)},
    {0x0000F800, 0x000007E0, 0x0000001F, 4, 0x000000FF, 0x0000FF00, 0x00FF0000,
     0, Blit_RGB565_ABGR8888, (blit_table::atype)(blit_table::NO_ALPHA | blit_table::COPY_ALPHA | blit_table::SET_ALPHA)},
    {0x0000F800, 0x000007E0, 0x0000001F, 4, 0xFF000000, 0x00FF0000, 0x0000FF00,
     0, Blit_RGB565_RGBA8888, (blit_table::atype)(blit_table::NO_ALPHA | blit_table::COPY_ALPHA | blit_table::SET_ALPHA)},
    {0x0000F800, 0x000007E0, 0x0000001F, 4, 0x0000FF00, 0x00FF0000, 0xFF000000,
     0, Blit_RGB565_BGRA8888, (blit_table::atype)(blit_table::NO_ALPHA | blit_table::COPY_ALPHA | blit_table::SET_ALPHA)},
...
static const struct blit_table normal_blit_4[] = {
    ...
    {0x00000000, 0x00000000, 0x00000000, 4, 0x00000000, 0x00000000, 0x00000000,
     6, ConvertAltivec32to32_noprefetch, blit_table::NO_ALPHA | COPY_ALPHA | SET_ALPHA},
    /* has-altivec */
    {0x00000000, 0x00000000, 0x00000000, 4, 0x00000000, 0x00000000, 0x00000000,
     2, ConvertAltivec32to32_prefetch, blit_table::NO_ALPHA | COPY_ALPHA | SET_ALPHA},
    /* has-altivec */
    {0x00000000, 0x00000000, 0x00000000, 2, 0x0000F800, 0x000007E0, 0x0000001F,
     2, Blit_RGB888_RGB565Altivec, blit_table::NO_ALPHA},
#endif
    {0x00FF0000, 0x0000FF00, 0x000000FF, 2, 0x0000F800, 0x000007E0, 0x0000001F,
     0, Blit_RGB888_RGB565, blit_table::NO_ALPHA},
    {0x00FF0000, 0x0000FF00, 0x000000FF, 2, 0x00007C00, 0x000003E0, 0x0000001F,
     0, Blit_RGB888_RGB555, blit_table::NO_ALPHA},
...
SDL_CalculateBlitN(SDL_Surface * surface)
{
    ...
    case 0:
        ...
        if (dstfmt->BitsPerPixel == 8) {
            ...
            int a_need = blit_table::NO_ALPHA;
            if (dstfmt->Amask)
                a_need = srcfmt->Amask ? blit_table::COPY_ALPHA : blit_table::SET_ALPHA;
            ...
            if (blitfun == BlitNtoN) {  /* default C fallback catch-all. Slow! */
                if (srcfmt->format == SDL_PIXELFORMAT_ARGB2101010) {
                    ...
                    if (a_need == blit_table::COPY_ALPHA) {
                ...
                } else if (a_need == blit_table::COPY_ALPHA) {
                    blitfun = BlitNtoNCopyAlpha;
                }
            }
        }
