...
const EventScriptCommand* EventData::setShowAllBobStatusBarCaptions_BOOL = new EventScriptCommand("setShowAllBobStatusBarCaptions_BOOL", "");
const EventScriptCommand* EventData::setShowBobStatusBar_BOOL = new EventScriptCommand("setShowBobStatusBar_BOOL", "");
