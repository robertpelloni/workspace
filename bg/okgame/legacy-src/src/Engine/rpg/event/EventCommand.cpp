...
EventCommand::EventCommand(Engine* g, const string& command, ArrayList<shared_ptr<EventParameter>>* parameterList, int type)
{ //===============================================================================================
...
shared_ptr<EventCommand> EventCommand::parseEventCommandFromCommandString(Engine* g, BobEvent* event, string commandString)
{ //===============================================================================================
	...
	{
		ArrayList<shared_ptr<EventParameter>>* newParameterList = new ArrayList<shared_ptr<EventParameter>>();
