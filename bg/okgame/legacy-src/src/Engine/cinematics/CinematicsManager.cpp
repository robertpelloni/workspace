...
{ //=========================================================================================================================
	screenOverlayUnderLights->doTransition(BobColor(ri, gi, bi), -1, toAlpha, ticks);
}

void CinematicsManager::setInstantOverlayColorUnderLights(u8 ri, u8 gi, u8 bi, float af)
{ //=========================================================================================================================
	screenOverlayUnderLights->setInstantOverlay(BobColor(ri, gi, bi), af);
}
...
{ //=========================================================================================================================
	screenOverlayGroundLayer->doTransition(BobColor(ri, gi, bi), -1, toAlpha, ticks);
}

void CinematicsManager::setInstantOverlayColorGroundLayer(u8 ri, u8 gi, u8 bi, float af)
{ //=========================================================================================================================
	screenOverlayGroundLayer->setInstantOverlay(BobColor(ri, gi, bi), af);
}
