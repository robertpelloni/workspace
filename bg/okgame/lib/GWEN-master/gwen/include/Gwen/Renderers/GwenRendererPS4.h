...
#ifndef GWEN_RENDERERS_PS4_H
#define GWEN_RENDERERS_PS4_H
...
namespace Gwen
{
	namespace Renderer
	{
		...
		class GWEN_EXPORT GwenRendererPS4 : public Gwen::Renderer::Base
		{
			public:

				GwenRendererPS4(  );//IDirect3DDevice9* pDevice = NULL
				~GwenRendererPS4();
